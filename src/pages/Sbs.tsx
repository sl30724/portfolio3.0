        ...
        <div className='content'>
            ...
            <div className='projectContent'>
                ...
                <p>Street Business School(SBS) is a global nonprofit on the mission to end global poverty by empowering women to become thriving entrepreneurs. Their main service is providing their grassroots partner organizations with their livelihood training curriculum to localize and implement the training in their communities through a train-the-trainer model.
                    <br />
                    <br />
                    As SBS enters a new phase of growth, they need a new website to better reflect their organizational sophistication, improve user experiences for everyone, and refine their messaging and product offering. My team and I joined the SBS’s website revamp project to help identify the current accessibility & usability issues and collect research insights for the new design.</p>
            </div>
            <div className='projectContent'>
                ...
                <p>With limited budget and a short timeline, we had to give up on user interviews. Instead, we came up with a strategized research plan to address the business’s goals without user interviews.</p>
            </div>
            <div className='projectContent'>
                ...
                <p>After meeting with SBS, together we identified these four pain points. With the initial user insights, we also agreed on that the mobile design and accessibility should be prioritized since the majority of audience accesses the site on mobile devices and sometimes with poor internet connection.</p>
            </div>
            <div className='projectContent'>
            ...
            <div className='projectContent'>
                ...
                <p>I created a detailed user persona for the two main audiences of SBS below to gain actionable user insights. To better incorporate accessibility in the design, they are both people with disabilities.
                    <br />
                    <ul>
            ...
            <div className='projectContent'>
                ...
                <div className='projectImg'>
                    ...
                    <p className='caption'>Cognitive walkthrough report screenshot (click to view in Google Doc)</p>
                </div>
                <p>Based on the user personas, I created a cognitive walkthrough to help us identify and validate the current pain points through a contextual user journey. This report was proven to be helpful as the designers often looked back on it when they ran into design dilemmas.</p>
            </div>
            <div className='projectContent'>
                ...
                <p>To improve accessibility and develop cohesive messaging on the site, I created an accessibility heuristic to lay out all the components that need to be redesigned and built to meet the WCAG2.0 AA standards, along with the potential approaches the team can take to improve them.</p>
            </div>
            <div className='projectContent'>
                ...
                <div className='projectImg'>
                    <div className='imgGallery'>
                        {/* <a href="https://drive.google.com/file/d/10K8Ty0HjT21H_Ne-0ezWmIRxEw6n2byh/view?usp=sharing" target='blank' rel='noreferrer' title='Accessibility Heuristic Report Google Doc'> */}
                        <img src="/pics/sbs/SBS_oldSiteMap.png" alt="Street Business School's old site map" />
                        {/* </a> */}
                        {/* <a href="https://drive.google.com/file/d/10K8Ty0HjT21H_Ne-0ezWmIRxEw6n2byh/view?usp=sharing" target='blank' rel='noreferrer' title='Accessibility Heuristic Report Google Doc'> */}
                        <img src="/pics/sbs/SBS_newSiteMap.png" alt="Street Business School's new site map" />
                        {/* </a> */}
                    </div>
